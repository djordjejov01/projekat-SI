...
@Component({
  selector: 'app-ticket-fail',
  imports: [CommonModule],
  templateUrl: './ticket-fail.component.html',
  styleUrl: './ticket-fail.component.css'
})
export class TicketFailComponent implements OnInit, AfterViewInit, OnDestroy, OnChanges {
